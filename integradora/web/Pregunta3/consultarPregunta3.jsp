        ...
        <div class="menuSuperior">
            ...
            <div>
                <label class="DescripcionPlantilla">
                    <strong>Plantilla 3 </strong>rubrica: EXCELENTE, BUENO, REGULAR, MALO, MUY MALO
                </label>
            </div>
        </div>
                ...
                <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="ServletPregunta3" method="post">
                                    <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">Pregunta nueva:</label>
